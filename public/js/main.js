...
document.querySelector(".form-background").style.display = ""

function openOverlay(el) {
  document.querySelector(".form-content").dataset.id = el.dataset.id
  document.querySelector(".form-background").classList.add("form-background--is-visible")
...
function closeForm() {
  document.querySelector(".form-background").classList.remove("form-background--is-visible")
